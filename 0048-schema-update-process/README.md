...
API versions of the package schema will not necessarily coincide with releases of the Zarf CLI. It likely will be the case that the v1 package schema will be released at the same time as Zarf v1.0.0, but it could be the case that a v2 package schema is released while the CLI version is still v1.0.0. 
